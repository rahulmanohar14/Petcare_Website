...
function UserDashboard() {
  ...
  const fetchRecentActivity = async () => {
    try {
      const groomingRes = await axios.get(`${API_BASE}/api/grooming`);
      const adoptionRes = await axios.get(`${API_BASE}/api/adoptions`);
      const vetRes = await axios.get(`${API_BASE}/api/appointments`);
